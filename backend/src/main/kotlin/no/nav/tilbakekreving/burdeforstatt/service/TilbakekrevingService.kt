...
class TilbakekrevingService(
    ...
    private fun opprettDummyKravgrunnlag(
        ...
        requestFraBurdeForstatt.perioder.forEach { periodeFraBurdeForstatt ->
            val splittetPeridoer = splittPeriodenHvisDetErFlereMåneder(periodeFraBurdeForstatt)
    ...
    private fun splittPeriodenHvisDetErFlereMåneder(periode: PeriodeIRequest): List<PeriodeDto> {
